...
DROP POLICY IF EXISTS "Admins and social media can create replies" ON public.contact_replies;
DROP POLICY IF EXISTS "Users can reply to their own messages" ON public.contact_replies;
DROP POLICY IF EXISTS "Can view replies to accessible messages" ON public.contact_replies;
...
DROP TRIGGER IF EXISTS update_contact_replies_updated_at ON public.contact_replies;
